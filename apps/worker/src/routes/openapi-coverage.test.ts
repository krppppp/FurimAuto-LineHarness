...
const CLIENT_ONLY: readonly string[] = [
  ...
  // FurimAuto fork 独自 (26): 管理UI・LP計測・GAS/運用スクリプトが叩く内部API。
  // upstream の spec には載せない (フォーク固有のため)。
  'DELETE /api/furim/friends/{id}/coupon',
  'DELETE /api/messages/{id}',
  'GET /api/analytics/lp-detail',
  'GET /api/analytics/lp-pages',
  'GET /api/chats/search',
  'GET /api/furim/chats/unread-count',
  'GET /api/furim/coupons',
  'GET /api/furim/friends/{id}/coupon',
  'GET /api/messages',
  'GET /api/messages/{id}',
  'GET /api/push/vapid-public-key',
  'POST /api/admin/sweep-stale-profiles',
  'POST /api/furim/backfill-plan-names',
  'POST /api/furim/friends/{id}/coupon',
  'POST /api/furim/grant-coupon',
  'POST /api/furim/migrate-subscriptions',
