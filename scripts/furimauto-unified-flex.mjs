...
const d5m = flexMsg('【1つのサイトで回ったら、次のステージへ】販路拡大はコピー出品で', bubble({
  ...
  body: [
    ...
    t('・無料でも、ワンクリックの手動コピーが使えます\n・有料なら、1品あたり10〜15円のチケット制で全自動の連続出品', { margin: 'md' }),
...
export const CLOSING_ACTIONS = [
  {
    ...
    messages: [
      closingMsg('【現在地の確認です】無料期間は残り5日になりました', bubble({
        ...
        footer: [uriBtn('Youtube動画講座を見る', 'https://youtube.com/playlist?list=PLUhATsy78sfvUHMVmeQpKMyxATlHOCEeF&si=4ZT_HFKCIGcuHibG', { color: '#FF0000' })],
      })),
    ],
  },
  {
